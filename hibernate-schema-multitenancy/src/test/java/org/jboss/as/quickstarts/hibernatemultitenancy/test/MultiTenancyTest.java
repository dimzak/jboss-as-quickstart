 ...
 */
package org.jboss.as.quickstarts.hibernatemultitenancy.test;

import java.sql.Connection;
import java.sql.SQLException;

import org.jboss.as.quickstarts.hibernatemultitenancy.model.Customer;
...
public class MultiTenancyTest extends BaseUnitTestCase {
	...
	protected Configuration buildConfiguration() {
		...
		cfg.setProperty(Environment.URL, "jdbc:h2:mem:hibernate-schema-multitenancy-quickstart;" +
				"DB_CLOSE_ON_EXIT=FALSE;DB_CLOSE_DELAY=-1");
		cfg.setProperty(Environment.USER, "sa");
		cfg.setProperty(Environment.PASS, "sa");
		cfg.setProperty(Environment.DRIVER, "h2");//same for org.h2.Driver
