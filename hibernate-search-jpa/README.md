...
This will deploy target/jboss-as-QUICKSTART_NAME.war (or target/jboss-as-QUICKSTART_NAME.ear) to the running instance of the server.
...
NOTE: The domain name for this application will be APPLICATION_NAME-YOUR_DOMAIN_NAME.rhcloud.com`. Here we use the quickstart domain. You will need to replace it with your own OpenShift domain name.
